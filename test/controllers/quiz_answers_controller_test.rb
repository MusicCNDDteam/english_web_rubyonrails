...
class QuizAnswersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quiz_answer" do
    assert_difference('QuizAnswer.count') do
      post quiz_answers_url, params: { quiz_answer: { content: @quiz_answer.content, correct: @quiz_answer.correct } }
    end
  ...
  test "should update quiz_answer" do
    patch quiz_answer_url(@quiz_answer), params: { quiz_answer: { content: @quiz_answer.content, correct: @quiz_answer.correct } }
